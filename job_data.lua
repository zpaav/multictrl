...
stage_data = {
	...
	['marm'] = { jobs = {
		...
		['GEO'] = {	'gs c set MagicBurstMode lock; gs c set elementalmode lightning; iacumen; gs c autogeo INT; gs c autoentrust fend;'},
		...
		['RUN'] = {	'gs c set hybridmode MEVA; gs c set RuneElement Sulpor; gs c set autotankmode on; hb buff me barwater; hb f off; ai dd off; gs c set MaintainVorV on'},
	...
	['wave2'] = { jobs = {
		['RDM'] = {	'mc buffall haste2; wait 1.0; mc buffall shell5; wait 1.0; hb buff me enthunder; hb buffjob tank refresh3,protect5,shell5; hb mincure 4; hb aoe on;',
					'hb buffjob GEO refresh3; dfull;  gs c set weapons Naegling; gs c autows savage blade; hb buffjob SAM refresh3,windstorm;'},
		['PLD'] = {	'hb as off; hb f off;'},
		...
		['GEO'] = {	'gfury; ibarrier; gs c autoentrust frailty; hb mincure 4; hb aoe on',
					'wait 0.7; hb buffjob BRD aurorastorm; hb buffjob tank aurorastorm;'},
	...
	['wave3'] = { jobs = {
		['RDM'] = {	'mc buffall haste2; wait 1.0; mc buffall shell5; wait 1.0; hb buff me enthunder; hb buffjob tank refresh3,protect5,shell5; hb mincure 4; hb aoe on;',
					'hb buffjob GEO refresh3; dvolte; gs c set weapons Crocea; gs c autows Seraph Blade; hb buffjob SAM refresh3,windstorm;'},
		['PLD'] = {	'hb as off; hb f off;'},
		['BRD'] = { 'wait 1; gs c set treasuremode tag; hb minwaltz 3; gs c weapons DualCarn; sing pl w3; sing n off; sing p on; sing d on; hb debuff wind threnody II; sing debuff carnage elegy; gs c set autozergmode off;',
					'wait 1.5; sing ballad 1 GEO; sing ballad 1 RDM;',
					'wait 1.5; sing sirvente tank; sing ballad 1 tank',
					'wait 1.5; sing ballad 1 WHM;'},
		['SAM'] = {	'gs c set hybridmode normal; gs c set weapons Dojikiri; gs c autows Tachi: Jinpu; gs c set DefenseDownMode tag; gs c set weaponskillmode Enmity;'},
		['GEO'] = {	'gmalaise; iacumen; gs c autoentrust fury; hb mincure 4; hb aoe on',
					'wait 0.7; hb buffjob BRD aurorastorm; hb buffjob tank aurorastorm;'},
		['COR'] = {	'gs c set weapons DualWildfire; gs c autows Wildfire; roll melee; wait 1; roll roll2 wizard;'},
	...
	['wave3boss'] = { jobs = {
		['RDM'] = {	'mc buffall haste2; wait 1.0; mc buffall shell5; wait 1.0; hb buff me enthunder; hb buffjob tank refresh3,protect5,shell5; hb mincure 4; hb aoe on;',
					'hb buffjob GEO refresh3; dw3boss; gs c set weapons None; hb buffjob SAM refresh3,windstorm; hb as attack off; wait 1; hb as nolock on; hb f off;'},
		['PLD'] = {	'hb as off; hb f off;'},
		['BRD'] = { 'wait 1; gs c set treasuremode tag; hb minwaltz 3; gs c weapons DualCarn; sing pl w3boss; sing n on; sing p on; sing d on; hb debuff wind threnody II; sing debuff carnage elegy; gs c set autozergmode off;',
					'wait 1.5; sing ballad 1 GEO; sing ballad 1 RDM;',
					'wait 1.5; sing sirvente tank; sing ballad 1 tank',
					'wait 1.5; sing ballad 1 WHM;'},
		['SAM'] = {	'gs c set hybridmode normal; gs c set weapons Dojikiri; gs c autows Tachi: Jinpu; gs c set DefenseDownMode tag; gs c set weaponskillmode Enmity;'},
		['GEO'] = {	'gmalaise; iacumen; gs c autoentrust fury; hb mincure 4; hb aoe on',
					'wait 0.7; hb buffjob BRD aurorastorm; hb buffjob tank aurorastorm;'},
		['COR'] = {	'gs c set weapons DualLeaden; gs c autows leaden salute; roll roll1 chaos; roll roll2 wizard;'},
		['ALL'] = {	commands = 'input /autotarget off; hb unignore_debuff all defense down,slow,addle,inhibit tp,plague,dia,bio', mc_settings = {autows=true,autosub='off'}},
	}},
